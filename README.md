...
1. at the end of the provision process, the temporary CBRAIN password will be displayed in the log, write it somewhere
1. `vagrant ssh`
1. `cd cbrain/BrainPortal`
1. `rails server puma -b 0.0.0.0 -p 3000 -e development`
